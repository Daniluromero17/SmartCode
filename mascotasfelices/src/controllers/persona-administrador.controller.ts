...
export class PersonaAdministradorController {
  ...
  async find(
    ...
    return this.personaRepository.administradores(id).find(filter);
  }
  ...
  async create(
    ...
    return this.personaRepository.administradores(id).create(administrador);
  }
  ...
  async patch(
    ...
    return this.personaRepository.administradores(id).patch(administrador, where);
  }
  ...
  async delete(
    ...
    return this.personaRepository.administradores(id).delete(where);
  }
}
