...
export class PersonaAsesorController {
  ...
  async find(
    ...
    return this.personaRepository.asesores(id).find(filter);
  }
  ...
  async create(
    ...
    return this.personaRepository.asesores(id).create(asesor);
  }
  ...
  async patch(
    ...
    return this.personaRepository.asesores(id).patch(asesor, where);
  }
  ...
  async delete(
    ...
    return this.personaRepository.asesores(id).delete(where);
  }
}
